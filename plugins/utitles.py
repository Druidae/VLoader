...
async def video_metadata(download_directory):
    """
...
async def vm_video_metadata(download_directory):
    """
    Extract metadata information for VMVideo files.
...
async def audio_metadata(download_directory):
    """
